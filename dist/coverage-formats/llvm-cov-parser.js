        ...
        for (const dataEntry of json.data) {
            ...
            for (const file of dataEntry.files) {
                ...
                if (coverage.executableLines.size === 0 && file.summary?.lines) {
                    ...
                    coverage.fileLevelCoverage = file.summary.lines.percent || 0;
                }
                if (coverage.executableLines.size > 0 || coverage.fileLevelCoverage !== undefined) {
