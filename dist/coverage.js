 ...
 */
const pathSimilarity = (path1, path2) => {
 ...
 */
const findBestMatch = (changedFile, allCoveredFiles, verbose = false) => {
 ...
 */
const extractUncoveredLines = (fileData) => {
 ...
 */
const extractUncoveredFunctions = (fileData) => {
