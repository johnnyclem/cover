...
export class FrameworkRegistry {
  private static frameworks = new Map<string, () => BaseFramework>();
  ...
  static getFramework(name: string): BaseFramework | null {
  ...
  static getFrameworksByType(type: 'unit' | 'integration' | 'e2e'): string[] {
  ...
  static registerFramework(name: string, factory: () => BaseFramework): void {
    this.frameworks.set(name.toLowerCase(), factory);
  }
}

export function createFramework(name: string): BaseFramework {
...
export function getUnitFrameworks(): string[] {
  return FrameworkRegistry.getFrameworksByType('unit');
}

export function getE2EFrameworks(): string[] {
